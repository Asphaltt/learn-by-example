...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang spinlock ./spinlock.c -- -D__TARGET_ARCH_x86 -I../headers -Wall
...
func main() {
	...
	var obj spinlockObjects
	errx.CheckVerifierErr(loadSpinlockObjects(&obj, nil), "Failed to load xdp objects")
	defer obj.Close()
