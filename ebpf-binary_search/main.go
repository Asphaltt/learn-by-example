...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -no-global-types -cc clang xdpfn ./xdp.c -- -D__TARGET_ARCH_x86 -I../ebpf-headers -Wall
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -no-global-types -cc clang xdpfnLoop ./xdp.c -- -D__TARGET_ARCH_x86 -D__USE_LOOP -I../ebpf-headers -Wall
